  ...
  return (
    <div className="max-w-6xl mx-auto px-4">
      ...
      <div className="text-center py-12 md:py-20">
        <div className="inline-block bg-zinc-800 text-zinc-300 px-3 py-1 rounded text-xs font-medium mb-4 md:mb-6 border border-zinc-700">
          F1 2025 SEASON
        </div>
        <h1 className="text-4xl md:text-5xl lg:text-7xl font-bold mb-4 md:mb-6 text-white">
          F1 Predictions
        </h1>
        <p className="text-base md:text-lg text-zinc-400 mb-8 md:mb-10 max-w-2xl mx-auto leading-relaxed px-4">
          Gjett hvem som vinner F1-mesterskapet 2025. Rangér driverne og tjen poeng
          basert på nøyaktigheten til prediksjonen din.
        </p>
        <div className="flex flex-col sm:flex-row gap-3 justify-center mb-12 md:mb-16 px-4">
          <Link
                ...
                <table className="w-full">
                  <thead className="border-b border-zinc-800">
                    <tr>
                      ...
                      <th className="px-3 md:px-6 py-3 text-right text-xs font-medium text-zinc-500 uppercase tracking-wider">
                        Totalt
                      </th>
                      <th className="hidden sm:table-cell px-3 md:px-6 py-3 text-right text-xs font-medium text-zinc-500 uppercase tracking-wider">
                        Siste race
                      </th>
                      <th className="hidden md:table-cell px-3 md:px-6 py-3 text-center text-xs font-medium text-zinc-500 uppercase tracking-wider">
                        Endring
                      </th>
                    </tr>
                  </thead>
                    ...
                    {leaderboard.map((user, idx) => (
                      <tr key={user.id} className="hover:bg-zinc-800/50 transition-colors">
                        <td className="px-3 md:px-6 py-4 whitespace-nowrap">
                          <div className="text-xl md:text-2xl font-bold text-zinc-600">
                            {idx + 1}
                          </div>
                        </td>
                        <td className="px-3 md:px-6 py-4 whitespace-nowrap">
                          <div className="font-medium text-sm md:text-base text-zinc-200">{user.name}</div>
                        </td>
                        <td className="px-3 md:px-6 py-4 whitespace-nowrap text-right">
                          <div className="text-lg md:text-xl font-semibold text-zinc-300">{user.totalPoints}</div>
                        </td>
                        <td className="hidden sm:table-cell px-3 md:px-6 py-4 whitespace-nowrap text-right">
                          <div className="text-base md:text-lg font-medium text-zinc-400">
      ...
      {/* How it Works */}
      <div className="bg-zinc-900 rounded-lg border border-zinc-800 p-6 md:p-8 mb-8">
        <h2 className="text-lg md:text-xl font-semibold mb-6 md:mb-8 text-white">Slik fungerer det</h2>
      ...
      {/* Points System */}
      <div className="bg-zinc-900 rounded-lg border border-zinc-800 p-6 md:p-8 mb-8">
        <h2 className="text-lg md:text-xl font-semibold mb-3 text-white">Poengsystem</h2>
        <p className="text-zinc-500 text-sm mb-6">
          Poeng tildeles basert på hvor mange posisjoner unna din prediksjonen er
        </p>
        <div className="grid grid-cols-3 sm:grid-cols-5 gap-2 md:gap-3 max-w-2xl">
          <div className="bg-zinc-800/50 rounded p-2 md:p-3 text-center border border-zinc-800">
            <div className="text-lg md:text-xl font-semibold text-zinc-300">25</div>
            <div className="text-xs text-zinc-600 mt-1">Eksakt</div>
          </div>
          <div className="bg-zinc-800/50 rounded p-2 md:p-3 text-center border border-zinc-800">
            <div className="text-lg md:text-xl font-semibold text-zinc-300">18</div>
            <div className="text-xs text-zinc-600 mt-1">±1</div>
          </div>
          <div className="bg-zinc-800/50 rounded p-2 md:p-3 text-center border border-zinc-800">
            <div className="text-lg md:text-xl font-semibold text-zinc-300">15</div>
            <div className="text-xs text-zinc-600 mt-1">±2</div>
          </div>
          <div className="hidden sm:block bg-zinc-800/50 rounded p-2 md:p-3 text-center border border-zinc-800">
            <div className="text-lg md:text-xl font-semibold text-zinc-300">12</div>
            <div className="text-xs text-zinc-600 mt-1">±3</div>
          </div>
          <div className="hidden sm:block bg-zinc-800/50 rounded p-2 md:p-3 text-center border border-zinc-800">
            <div className="text-lg md:text-xl font-semibold text-zinc-300">...</div>
      ...
      <div className="text-center py-8">
        <Link
          href="/admin/sync"
          className="text-zinc-700 hover:text-zinc-600 text-xs transition-colors"
        >
          •
        </Link>
      </div>
