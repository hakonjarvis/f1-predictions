        ...
        <table className="w-full">
          <thead className="border-b border-zinc-800">
            <tr>
              ...
              <th className="px-3 md:px-6 py-3 text-center text-xs font-medium text-zinc-500 uppercase tracking-wider">
              ...
              <>
                ...
                >
                  <td className="px-3 md:px-6 py-4 whitespace-nowrap">
                    <div className="text-base md:text-lg font-semibold text-zinc-400">{idx + 1}</div>
                  </td>
                  <td className="px-3 md:px-6 py-4 whitespace-nowrap">
                    <div className="text-sm font-medium text-zinc-200">{user.name}</div>
                  </td>
                  <td className="px-3 md:px-6 py-4 whitespace-nowrap text-right">
                    <div className="text-base md:text-lg font-semibold text-zinc-300">{user.totalPoints}</div>
                  </td>
                ...
                {expandedUserId === user.id && (
                  <tr>
                    <td colSpan={4} className="px-3 md:px-6 py-4 bg-zinc-950/50">
                            ...
                            {user.raceBreakdown.map((race) => (
                              ...
                              >
                                ...
                                <div className="text-right">
                                  <p className="text-base md:text-lg font-semibold text-zinc-300">
                                    {race.points}
                                  </p>
